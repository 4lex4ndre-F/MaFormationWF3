...
// 2 - PDO: exec()
// insert
//   $resultat = $pdo->exec("INSERT INTO employes (prenom, nom, sexe, service, salaire, date_embauche) VALUES ('prenomtest7', 'nomtest', 'm', 'informatique', 2000, '2017-06-22'), ('prenomtest8', 'nomtest', 'm', 'informatique', 2000, '2017-06-22')");
...
// en l'état, $resultat est inexploitable. Nous devons le traiter avec la methode fetch afin de rendre les informations exploitables.
...
//$info_employe = $resultat->fetch(); // ou $info_employe = $resultat->fetch(PDO::FETCH_BOTH); // c'est le mode par defaut // FETCH_BOTH est un melange de FETCH_ASSOC + FETCH_NUM

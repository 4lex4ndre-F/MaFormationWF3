...
$_SESSION['pseudo'] = "Marie"; // $_SESSION est une superglobale, toutes les suprglobales sans exceptions sont des tableaux array. Il est donc possible de créer des indices avec valeurs dans notre session.
...
session_destroy(); // nous permet de supprimer la session, EN REVANCHE il faut savoir que l'information session_destroy() est vu par l'interpréteur php, mise de coté puis exécutée uniquement à la fin du script en cours.

echo 'Troisème affichage de la session après le session_destroy(): <br />';
echo '<pre>'; print_r($_SESSION); echo '</pre>';
